  ...
  componentWillMount() {
    ...
    this.available_drivers_channel.bind('client-driver-request', (passenger_data) => {
      ...
      if(!this.state.has_passenger){
        ...
        Alert.alert(
          "It's a match!A passenger is looking to the same destination as you!",
                  ...
                  this.ride_channel.bind('client-driver-response', (driver_response) => {
                    ...
                    if(driver_response.response == 'yes'){
                      ...
                      Alert.alert(
                        ...
                        "Another driver was closer and reached the pick-up location before you.",
                        [
                          {
                            text: 'Ok'
                          },
        ...
        if(this.state.has_passenger && this.state.passenger){
          ...
          if(diff_in_meter_pickup <= 20){
            ...
            if(!this.state.has_ridden){
              ...
              this.ride_channel.trigger('client-driver-message', {
                ...
                msg: 'Your driver is near, please be ready at the pick-up location!'
              });
          ...
          if(diff_in_meter_dropoff <= 20){
            this.ride_channel.trigger('client-driver-message', {
              ...
              msg: "You're approaching your final destination. At the dropoff you will be required to pay the driver."
            });
      ...
      <View style={styles.container}>
        {
          ...
          >
              <MapView.Marker
                ...
                latitude: this.state.region.latitude, 
                longitude: this.state.region.longitude}}
                title={"You've reached the pick-up location"}
              />
              
              {
                ...
                <MapView.Marker
                  ...
                  title={"Your passenger has arrived at the pick-up destination"}
                  pinColor={"#4CDB00"}
                />
              }
          </MapView>
